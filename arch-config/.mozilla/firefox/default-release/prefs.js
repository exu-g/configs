...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1715966287);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1716015521);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1716011920);
user_pref("app.update.lastUpdateTime.region-update-timer", 1715966287);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1716014613);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1715966287);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1715969887);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1715966287);
...
user_pref("browser.region.update.updated", 1715966288);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.malware.enabled", false);
user_pref("browser.safebrowsing.phishing.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1716011892895");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1716033492895");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20230925122949");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1716014611");
...
user_pref("browser.startup.lastColdStartupCheck", 1716014612);
...
user_pref("extensions.dnr.lastStoreUpdateTag.5f25abbb-d076-4c4f-b285-9a0086d69305", "{453d12e7-b6d2-4381-90c6-63b02617ecf9}");
user_pref("extensions.getAddons.cache.lastUpdate", 1716014612);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1715966865);
...
user_pref("idle.lastDailyNotification", 1715966375);
...
user_pref("media.gmp-manager.lastCheck", 1715966278);
user_pref("media.gmp-manager.lastEmptyCheck", 1715415332);
...
user_pref("places.database.lastMaintenance", 1715966375);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1716011893);
user_pref("services.settings.blocklists.gfx.last_check", 1716011893);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1716004630819\"");
user_pref("services.settings.last_update_seconds", 1716011893);
user_pref("services.settings.main.addons-manager-settings.last_check", 1716011893);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1716011893);
user_pref("services.settings.main.cfr.last_check", 1716011893);
user_pref("services.settings.main.cookie-banner-rules-list.last_check", 1716011893);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1716011893);
user_pref("services.settings.main.devtools-devices.last_check", 1716011893);
user_pref("services.settings.main.doh-config.last_check", 1716011893);
user_pref("services.settings.main.doh-providers.last_check", 1716011893);
user_pref("services.settings.main.fingerprinting-protection-overrides.last_check", 1716011893);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1716011893);
user_pref("services.settings.main.hijack-blocklists.last_check", 1716011893);
user_pref("services.settings.main.language-dictionaries.last_check", 1716011893);
user_pref("services.settings.main.message-groups.last_check", 1716011893);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1716011893);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1716011893);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1716011893);
user_pref("services.settings.main.password-recipes.last_check", 1716011893);
user_pref("services.settings.main.password-rules.last_check", 1716011893);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1716011893);
user_pref("services.settings.main.public-suffix-list.last_check", 1716011893);
user_pref("services.settings.main.query-stripping.last_check", 1716011893);
user_pref("services.settings.main.search-config-icons.last_check", 1716011893);
user_pref("services.settings.main.search-config-overrides-v2.last_check", 1716011893);
user_pref("services.settings.main.search-config-overrides.last_check", 1716011893);
user_pref("services.settings.main.search-config-v2.last_check", 1716011893);
user_pref("services.settings.main.search-config.last_check", 1716011893);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1716011893);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1716011893);
user_pref("services.settings.main.sites-classification.last_check", 1716011893);
user_pref("services.settings.main.tippytop.last_check", 1716011893);
user_pref("services.settings.main.top-sites.last_check", 1716011893);
user_pref("services.settings.main.translations-identification-models.last_check", 1716011893);
user_pref("services.settings.main.translations-models.last_check", 1716011893);
user_pref("services.settings.main.translations-wasm.last_check", 1716011893);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1716011893);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1716011893);
user_pref("services.settings.main.whats-new-panel.last_check", 1716011893);
user_pref("services.settings.security-state.cert-revocations.last_check", 1715969864);
user_pref("services.settings.security-state.intermediates.last_check", 1715969864);
user_pref("services.settings.security-state.onecrl.last_check", 1715969864);
user_pref("services.sync.addons.lastSync", "1712412070.17");
...
user_pref("services.sync.clients.lastRecordUpload", 1716014615);
user_pref("services.sync.clients.lastSync", "1716014615.14");
...
user_pref("services.sync.lastPing", 1715966260);
user_pref("services.sync.lastSync", "Sat May 18 2024 09:11:56 GMT+0200 (Mitteleuropäische Sommerzeit)");
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1713692659);
user_pref("storage.vacuum.last.index", 2);
user_pref("storage.vacuum.last.places.sqlite", 1713599190);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.startup.last_success", 1716014610);
