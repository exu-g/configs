...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1629568143);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1638427774);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1629621777);
user_pref("app.update.lastUpdateTime.region-update-timer", 1629438059);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1638427818);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1638427845);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1629568023);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1629446832);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1629568263);
...
user_pref("browser.region.update.updated", 1629438059);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1638427819647");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1638429629647");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1638427820632");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1638449420632");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1638427816");
...
user_pref("browser.startup.lastColdStartupCheck", 1638427816);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1629568144);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1629571109);
...
user_pref("idle.lastDailyNotification", 1629570364);
...
user_pref("media.gmp-manager.lastCheck", 1638427844);
...
user_pref("places.database.lastMaintenance", 1629570364);
...
user_pref("security.remote_settings.crlite_filters.checked", 1629554624);
user_pref("security.remote_settings.intermediates.checked", 1629554624);
...
user_pref("services.blocklist.addons-mlbf.checked", 1629621510);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1629621510);
...
user_pref("services.settings.last_update_seconds", 1629621510);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1629621510);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1629621510);
user_pref("services.settings.main.doh-config.last_check", 1629621510);
user_pref("services.settings.main.doh-providers.last_check", 1629621510);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1629621510);
user_pref("services.settings.main.hijack-blocklists.last_check", 1629621510);
user_pref("services.settings.main.language-dictionaries.last_check", 1629621510);
user_pref("services.settings.main.message-groups.last_check", 1629621510);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1629621510);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1629621510);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1629621510);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1629621510);
user_pref("services.settings.main.password-recipes.last_check", 1629621510);
user_pref("services.settings.main.password-rules.last_check", 1629621510);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1629621510);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1629621510);
user_pref("services.settings.main.public-suffix-list.last_check", 1629621510);
user_pref("services.settings.main.query-stripping.last_check", 1629621510);
user_pref("services.settings.main.search-config.last_check", 1629621510);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1629621510);
user_pref("services.settings.main.search-telemetry.last_check", 1629621510);
user_pref("services.settings.main.sites-classification.last_check", 1629621510);
user_pref("services.settings.main.tippytop.last_check", 1629621510);
user_pref("services.settings.main.top-sites.last_check", 1629621510);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1629621510);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1629621510);
user_pref("services.settings.main.whats-new-panel.last_check", 1629621510);
user_pref("services.settings.security.onecrl.checked", 1629554624);
user_pref("services.sync.addons.lastSync", "1636960491.52");
...
user_pref("services.sync.clients.lastRecordUpload", 1638427832);
user_pref("services.sync.clients.lastSync", "1638427832.87");
...
user_pref("services.sync.lastPing", 1638427832);
user_pref("services.sync.lastSync", "Thu Dec 02 2021 07:50:35 GMT+0100 (Central European Standard Time)");
user_pref("services.sync.lastTabFetch", 1586120826);
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.passwords.syncID", "-WeMPm6W3NJC");
user_pref("services.sync.prefs.lastSync", "1638427835.32");
...
user_pref("storage.vacuum.last.places.sqlite", 1629025105);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.scrollbox.horizontalScrollDistance", 4);
user_pref("toolkit.startup.last_success", 1638427813);
user_pref("toolkit.telemetry.cachedClientID", "d0fd8bb3-f426-40cc-8685-fb020cb0f742");
