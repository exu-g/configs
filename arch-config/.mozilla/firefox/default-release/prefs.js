...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1696756146);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1696791730);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1696791608);
user_pref("app.update.lastUpdateTime.region-update-timer", 1696785862);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1696792673);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1696756146);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1696789462);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1696756146);
...
user_pref("browser.region.update.updated", 1696785863);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.malware.enabled", false);
user_pref("browser.safebrowsing.phishing.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1696791586808");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1696813186808");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20230925122949");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1696792672");
...
user_pref("browser.startup.lastColdStartupCheck", 1696792671);
...
user_pref("extensions.dnr.lastStoreUpdateTag.5f25abbb-d076-4c4f-b285-9a0086d69305", "{618fdbda-baab-43eb-9bbb-87953b188061}");
user_pref("extensions.getAddons.cache.lastUpdate", 1696756147);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1696757738);
...
user_pref("idle.lastDailyNotification", 1696756441);
...
user_pref("media.gmp-manager.lastCheck", 1696748398);
user_pref("media.gmp-manager.lastEmptyCheck", 1696748398);
...
user_pref("places.database.lastMaintenance", 1696357419);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1696751986);
user_pref("services.settings.blocklists.gfx.last_check", 1696751986);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1696777035092\"");
user_pref("services.settings.last_update_seconds", 1696791650);
user_pref("services.settings.main.addons-manager-settings.last_check", 1696751986);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1696751986);
user_pref("services.settings.main.cfr.last_check", 1696751986);
user_pref("services.settings.main.cookie-banner-rules-list.last_check", 1696751986);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1696751986);
user_pref("services.settings.main.devtools-devices.last_check", 1696751986);
user_pref("services.settings.main.doh-config.last_check", 1696751986);
user_pref("services.settings.main.doh-providers.last_check", 1696751986);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1696751986);
user_pref("services.settings.main.hijack-blocklists.last_check", 1696751986);
user_pref("services.settings.main.language-dictionaries.last_check", 1696751986);
user_pref("services.settings.main.message-groups.last_check", 1696751986);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1696751986);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1696751986);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1696751986);
user_pref("services.settings.main.password-recipes.last_check", 1696751986);
user_pref("services.settings.main.password-rules.last_check", 1696751986);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1696751986);
user_pref("services.settings.main.public-suffix-list.last_check", 1696751986);
user_pref("services.settings.main.query-stripping.last_check", 1696751986);
user_pref("services.settings.main.search-config.last_check", 1696751986);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1696751986);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1696751986);
user_pref("services.settings.main.sites-classification.last_check", 1696751986);
user_pref("services.settings.main.tippytop.last_check", 1696751986);
user_pref("services.settings.main.top-sites.last_check", 1696751986);
user_pref("services.settings.main.translations-identification-models.last_check", 1696751986);
user_pref("services.settings.main.translations-models.last_check", 1696751986);
user_pref("services.settings.main.translations-wasm.last_check", 1696751986);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1696751986);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1696751986);
user_pref("services.settings.main.whats-new-panel.last_check", 1696751986);
user_pref("services.settings.security-state.cert-revocations.last_check", 1696777226);
user_pref("services.settings.security-state.intermediates.last_check", 1696751986);
user_pref("services.settings.security-state.onecrl.last_check", 1696751986);
...
user_pref("services.sync.clients.lastRecordUpload", 1696792675);
user_pref("services.sync.clients.lastSync", "1696792675.67");
...
user_pref("services.sync.lastPing", 1696757133);
user_pref("services.sync.lastSync", "Sun Oct 08 2023 21:17:55 GMT+0200 (Central European Summer Time)");
...
user_pref("storage.vacuum.last.places.sqlite", 1696670040);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.startup.last_success", 1696792666);
