...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1663780525);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1663787485);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1663781005);
user_pref("app.update.lastUpdateTime.region-update-timer", 1663263369);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1663780765);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1663780885);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1663780405);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1663263489);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1663780645);
...
user_pref("browser.region.update.updated", 1663263370);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1663780259740");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1663801859740");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1663780257");
...
user_pref("browser.startup.lastColdStartupCheck", 1663780256);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1663780525);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1663780355);
...
user_pref("idle.lastDailyNotification", 1663781995);
...
user_pref("media.gmp-manager.lastCheck", 1663780284);
user_pref("media.gmp-manager.lastEmptyCheck", 1663780284);
user_pref("media.gmp-widevinecdm.abi", "x86_64-gcc3");
user_pref("media.gmp-widevinecdm.lastDownload", 1661264571);
user_pref("media.gmp-widevinecdm.lastInstallStart", 1661264570);
user_pref("media.gmp-widevinecdm.lastUpdate", 1661264571);
...
user_pref("places.database.lastMaintenance", 1663270751);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1663783562);
user_pref("services.settings.blocklists.gfx.last_check", 1663783562);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1663787206993\"");
user_pref("services.settings.last_update_seconds", 1663787464);
user_pref("services.settings.main.addons-manager-settings.last_check", 1663783562);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1663783562);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1663783562);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1663783562);
user_pref("services.settings.main.devtools-devices.last_check", 1663783562);
user_pref("services.settings.main.doh-config.last_check", 1663783562);
user_pref("services.settings.main.doh-providers.last_check", 1663783562);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1663783562);
user_pref("services.settings.main.hijack-blocklists.last_check", 1663783562);
user_pref("services.settings.main.language-dictionaries.last_check", 1663783562);
user_pref("services.settings.main.message-groups.last_check", 1663783562);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1663783562);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1663785663);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1663783562);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1663783562);
user_pref("services.settings.main.password-recipes.last_check", 1663783562);
user_pref("services.settings.main.password-rules.last_check", 1663783562);
user_pref("services.settings.main.personality-provider-models.last_check", 1663783562);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1663783562);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1663783562);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1663783562);
user_pref("services.settings.main.public-suffix-list.last_check", 1663783562);
user_pref("services.settings.main.query-stripping.last_check", 1663783562);
user_pref("services.settings.main.search-config.last_check", 1663783562);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1663783562);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1663783562);
user_pref("services.settings.main.search-telemetry.last_check", 1663783562);
user_pref("services.settings.main.sites-classification.last_check", 1663783562);
user_pref("services.settings.main.tippytop.last_check", 1663783562);
user_pref("services.settings.main.top-sites.last_check", 1663783562);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1663783562);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1663783562);
user_pref("services.settings.main.whats-new-panel.last_check", 1663783562);
user_pref("services.settings.security-state.cert-revocations.last_check", 1663787164);
user_pref("services.settings.security-state.intermediates.last_check", 1663787164);
user_pref("services.settings.security-state.onecrl.last_check", 1663783562);
user_pref("services.settings.security.onecrl.checked", 1654758333);
user_pref("services.sync.addons.lastSync", "1663761494.74");
...
user_pref("services.sync.clients.lastRecordUpload", 1663780263);
user_pref("services.sync.clients.lastSync", "1663782524.57");
...
user_pref("services.sync.lastPing", 1663780261);
user_pref("services.sync.lastSync", "Wed Sep 21 2022 21:19:15 GMT+0200 (Central European Summer Time)");
user_pref("services.sync.lastTabFetch", 1586120826);
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.passwords.syncID", "-WeMPm6W3NJC");
user_pref("services.sync.prefs.lastSync", "1660224601.56");
...
user_pref("storage.vacuum.last.places.sqlite", 1661362292);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.scrollbox.horizontalScrollDistance", 4);
user_pref("toolkit.startup.last_success", 1663780252);
