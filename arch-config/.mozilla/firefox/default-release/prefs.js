...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1688475191);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1688475191);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1688475191);
user_pref("app.update.lastUpdateTime.region-update-timer", 1688475191);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1688476311);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1688475191);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1688475221);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1688475191);
...
user_pref("browser.pageActions.persistedActions", "{\"ids\":[\"bookmark\",\"jid0-3guet1r69sqnsrca5p8kx9ezc3u_jetpack\",\"_testpilot-containers\",\"firefox-translations-addon_mozilla_org\"],\"idsInUrlbar\":[\"jid0-3guet1r69sqnsrca5p8kx9ezc3u_jetpack\",\"_testpilot-containers\",\"firefox-translations-addon_mozilla_org\",\"bookmark\"],\"idsInUrlbarPreProton\":[],\"version\":1}");
user_pref("browser.pagethumbnails.storage_version", 3);
user_pref("browser.pdfjs.feature-tour", "{\"screen\":\"\",\"complete\":true}");
user_pref("browser.proton.enabled", true);
user_pref("browser.proton.toolbar.version", 3);
user_pref("browser.region.update.updated", 1688475162);
user_pref("browser.safebrowsing.malware.enabled", false);
user_pref("browser.safebrowsing.phishing.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1688475164803");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1688496764803");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20230620210812");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1688476311");
...
user_pref("browser.startup.lastColdStartupCheck", 1688476311);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1688475192);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{aac7a33b-d93f-4851-a2e5-39d8ff2f1d7f}\",\"addons\":{\"addons-restricted-domains@mozilla.com\":{\"version\":\"1.0.0buildid20230525.154501\"}}}");
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1688475286);
...
user_pref("media.gmp-gmpopenh264.lastDownload", 1688475177);
user_pref("media.gmp-gmpopenh264.lastInstallStart", 1688475176);
user_pref("media.gmp-gmpopenh264.lastUpdate", 1688475177);
user_pref("media.gmp-gmpopenh264.version", "1.8.1.2");
user_pref("media.gmp-manager.buildID", "20230620210812");
user_pref("media.gmp-manager.lastCheck", 1688475176);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1688476256);
user_pref("services.settings.blocklists.gfx.last_check", 1688476256);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1688474270606\"");
user_pref("services.settings.last_update_seconds", 1688476256);
user_pref("services.settings.main.addons-manager-settings.last_check", 1688476256);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1688476256);
user_pref("services.settings.main.cfr.last_check", 1688476256);
user_pref("services.settings.main.cookie-banner-rules-list.last_check", 1688476256);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1688476256);
user_pref("services.settings.main.devtools-devices.last_check", 1688476256);
user_pref("services.settings.main.doh-config.last_check", 1688476256);
user_pref("services.settings.main.doh-providers.last_check", 1688476256);
user_pref("services.settings.main.hijack-blocklists.last_check", 1688476256);
user_pref("services.settings.main.language-dictionaries.last_check", 1688476256);
user_pref("services.settings.main.message-groups.last_check", 1688476256);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1688476256);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1688476256);
user_pref("services.settings.main.password-recipes.last_check", 1688476256);
user_pref("services.settings.main.password-rules.last_check", 1688476256);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1688476256);
user_pref("services.settings.main.query-stripping.last_check", 1688476256);
user_pref("services.settings.main.search-config.last_check", 1688476256);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1688476256);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1688476256);
user_pref("services.settings.main.sites-classification.last_check", 1688476256);
user_pref("services.settings.main.top-sites.last_check", 1688476256);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1688476256);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1688476256);
user_pref("services.settings.main.whats-new-panel.last_check", 1688476256);
user_pref("services.sync.addons.lastSync", "1688475286.99");
...
user_pref("services.sync.clients.lastRecordUpload", 1688476314);
user_pref("services.sync.clients.lastSync", "1688476314.88");
...
user_pref("services.sync.lastPing", 1688475164);
user_pref("services.sync.lastSync", "Tue Jul 04 2023 15:11:55 GMT+0200 (Central European Summer Time)");
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.prefs.lastSync", "1688475549.05");
...
user_pref("toolkit.startup.last_success", 1688476310);
