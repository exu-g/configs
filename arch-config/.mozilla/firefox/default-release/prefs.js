...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1695479822);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1695479822);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1695479822);
user_pref("app.update.lastUpdateTime.region-update-timer", 1694971460);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1695479822);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1695479822);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1694975060);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1695479822);
...
user_pref("browser.region.update.updated", 1694971461);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.malware.enabled", false);
user_pref("browser.safebrowsing.phishing.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1695479797948");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1695501397948");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20230828231221");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1695479793");
...
user_pref("browser.startup.lastColdStartupCheck", 1695479792);
...
user_pref("extensions.dnr.lastStoreUpdateTag.5f25abbb-d076-4c4f-b285-9a0086d69305", "{ec9ce011-a313-48ec-89ef-64759daf5e67}");
user_pref("extensions.getAddons.cache.lastUpdate", 1695479822);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1695479899);
...
user_pref("idle.lastDailyNotification", 1695317796);
...
user_pref("media.gmp-gmpopenh264.lastInstallStart", 1690222443);
...
user_pref("media.gmp-manager.lastCheck", 1695479842);
user_pref("media.gmp-manager.lastEmptyCheck", 1695479842);
...
user_pref("media.gmp-widevinecdm.lastDownload", 1688475179);
user_pref("media.gmp-widevinecdm.lastInstallStart", 1688475177);
user_pref("media.gmp-widevinecdm.lastUpdate", 1688475179);
...
user_pref("places.database.lastMaintenance", 1694972330);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1695479799);
user_pref("services.settings.blocklists.gfx.last_check", 1695479799);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1695459436797\"");
user_pref("services.settings.last_update_seconds", 1695479822);
user_pref("services.settings.main.addons-manager-settings.last_check", 1695479799);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1695479799);
user_pref("services.settings.main.cfr.last_check", 1695479799);
user_pref("services.settings.main.cookie-banner-rules-list.last_check", 1695479799);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1695479799);
user_pref("services.settings.main.devtools-devices.last_check", 1695479799);
user_pref("services.settings.main.doh-config.last_check", 1695479799);
user_pref("services.settings.main.doh-providers.last_check", 1695479799);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1695479799);
user_pref("services.settings.main.hijack-blocklists.last_check", 1695479799);
user_pref("services.settings.main.language-dictionaries.last_check", 1695479799);
user_pref("services.settings.main.message-groups.last_check", 1695479799);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1695479799);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1695479799);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1695479799);
user_pref("services.settings.main.password-recipes.last_check", 1695479799);
user_pref("services.settings.main.password-rules.last_check", 1695479799);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1695479799);
user_pref("services.settings.main.public-suffix-list.last_check", 1695479799);
user_pref("services.settings.main.query-stripping.last_check", 1695479799);
user_pref("services.settings.main.search-config.last_check", 1695479799);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1695479799);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1695479799);
user_pref("services.settings.main.sites-classification.last_check", 1695479799);
user_pref("services.settings.main.tippytop.last_check", 1695479799);
user_pref("services.settings.main.top-sites.last_check", 1695479799);
user_pref("services.settings.main.translations-identification-models.last_check", 1695479799);
user_pref("services.settings.main.translations-models.last_check", 1695479799);
user_pref("services.settings.main.translations-wasm.last_check", 1695479799);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1695479799);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1695479799);
user_pref("services.settings.main.whats-new-panel.last_check", 1695479799);
user_pref("services.settings.security-state.cert-revocations.last_check", 1695328036);
user_pref("services.settings.security-state.intermediates.last_check", 1695328036);
user_pref("services.settings.security-state.onecrl.last_check", 1695328036);
user_pref("services.sync.addons.lastSync", "1694169634.61");
...
user_pref("services.sync.clients.lastRecordUpload", 1695479803);
user_pref("services.sync.clients.lastSync", "1695479803.03");
...
user_pref("services.sync.lastPing", 1695479800);
user_pref("services.sync.lastSync", "Sat Sep 23 2023 16:48:20 GMT+0200 (Central European Summer Time)");
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.prefs.lastSync", "1689087167.02");
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1694185540);
user_pref("storage.vacuum.last.index", 2);
user_pref("storage.vacuum.last.places.sqlite", 1694023118);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.startup.last_success", 1695479788);
