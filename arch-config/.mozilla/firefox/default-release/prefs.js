...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1652291619);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1652294739);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1652291259);
user_pref("app.update.lastUpdateTime.region-update-timer", 1652114369);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1652291379);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1652291019);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1652291499);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1652114489);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1652291739);
...
user_pref("browser.pageActions.persistedActions", "{\"version\":1,\"ids\":[\"bookmark\",\"jid0-3guet1r69sqnsrca5p8kx9ezc3u_jetpack\",\"_testpilot-containers\",\"_036a55b4-5e72-4d05-a06c-cba2dfcc134a_\"],\"idsInUrlbar\":[\"jid0-3guet1r69sqnsrca5p8kx9ezc3u_jetpack\",\"_testpilot-containers\",\"_036a55b4-5e72-4d05-a06c-cba2dfcc134a_\",\"bookmark\"],\"idsInUrlbarPreProton\":[\"bookmark\"]}");
user_pref("browser.pagethumbnails.storage_version", 3);
user_pref("browser.protections_panel.infoMessage.seen", true);
user_pref("browser.proton.enabled", true);
user_pref("browser.proton.places-tooltip.enabled", true);
user_pref("browser.proton.toolbar.version", 3);
user_pref("browser.region.update.updated", 1652114369);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1652296359413");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1652298150413");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1652290998236");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1652312598236");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1652290993");
...
user_pref("browser.startup.lastColdStartupCheck", 1652290992);
...
user_pref("devtools.toolbox.sidebar.width", 637);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1652291620);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{e922249f-06f4-4b21-8432-b88d086efe04}\",\"addons\":{\"webcompat@mozilla.org\":{\"version\":\"100.2.1buildid20220504.194401\"}}}");
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1652291598);
...
user_pref("idle.lastDailyNotification", 1652291242);
...
user_pref("media.gmp-manager.lastCheck", 1652291039);
...
user_pref("places.database.lastMaintenance", 1651688292);
...
user_pref("security.remote_settings.crlite_filters.checked", 1652294598);
...
user_pref("services.blocklist.addons-mlbf.checked", 1652294598);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1652294598);
...
user_pref("services.settings.last_etag", "\"1652296222697\"");
user_pref("services.settings.last_update_seconds", 1652296398);
user_pref("services.settings.main.addons-manager-settings.last_check", 1652294598);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1652294598);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1652294598);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1652294598);
user_pref("services.settings.main.doh-config.last_check", 1652294598);
user_pref("services.settings.main.doh-providers.last_check", 1652294598);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1652294598);
user_pref("services.settings.main.hijack-blocklists.last_check", 1652294598);
user_pref("services.settings.main.language-dictionaries.last_check", 1652294598);
user_pref("services.settings.main.message-groups.last_check", 1652294598);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1652294598);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1652294598);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1652294598);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1652294598);
user_pref("services.settings.main.password-recipes.last_check", 1652294598);
user_pref("services.settings.main.password-rules.last_check", 1652294598);
user_pref("services.settings.main.personality-provider-models.last_check", 1652294598);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1652294598);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1652294598);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1652294598);
user_pref("services.settings.main.public-suffix-list.last_check", 1652294598);
user_pref("services.settings.main.query-stripping.last_check", 1652294598);
user_pref("services.settings.main.search-config.last_check", 1652294598);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1652294598);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1652294598);
user_pref("services.settings.main.search-telemetry.last_check", 1652294598);
user_pref("services.settings.main.sites-classification.last_check", 1652294598);
user_pref("services.settings.main.tippytop.last_check", 1652294598);
user_pref("services.settings.main.top-sites.last_check", 1652294598);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1652294598);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1652294598);
user_pref("services.settings.main.whats-new-panel.last_check", 1652294598);
user_pref("services.settings.security.onecrl.checked", 1652294598);
user_pref("services.sync.addons.lastSync", "1652171915.62");
...
user_pref("services.sync.clients.lastRecordUpload", 1652290997);
user_pref("services.sync.clients.lastSync", "1652290997.54");
...
user_pref("services.sync.lastPing", 1652290996);
user_pref("services.sync.lastSync", "Wed May 11 2022 21:12:34 GMT+0200 (Central European Summer Time)");
user_pref("services.sync.lastTabFetch", 1586120826);
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.passwords.syncID", "-WeMPm6W3NJC");
user_pref("services.sync.prefs.lastSync", "1652115368.40");
...
user_pref("storage.vacuum.last.places.sqlite", 1652201016);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.scrollbox.horizontalScrollDistance", 4);
user_pref("toolkit.startup.last_success", 1652290985);
