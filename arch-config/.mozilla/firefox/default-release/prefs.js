...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1651688058);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1651769232);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1651688658);
user_pref("app.update.lastUpdateTime.region-update-timer", 1651413462);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1651769204);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1651688538);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1651687938);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1651413582);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1651688178);
...
user_pref("browser.region.update.updated", 1651413464);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1651769209410");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1651771007410");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1651769210118");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1651790810118");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1651769206");
...
user_pref("browser.startup.lastColdStartupCheck", 1651769205);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1651688058);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1651688515);
...
user_pref("idle.lastDailyNotification", 1651688292);
...
user_pref("media.gmp-manager.lastCheck", 1651688253);
...
user_pref("security.remote_settings.crlite_filters.checked", 1651590128);
user_pref("security.remote_settings.intermediates.checked", 1651555585);
...
user_pref("services.blocklist.addons-mlbf.checked", 1651769207);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1651769207);
...
user_pref("services.settings.last_etag", "\"1651766434434\"");
user_pref("services.settings.last_update_seconds", 1651769207);
user_pref("services.settings.main.addons-manager-settings.last_check", 1651769207);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1651769207);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1651769207);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1651769207);
user_pref("services.settings.main.doh-config.last_check", 1651769207);
user_pref("services.settings.main.doh-providers.last_check", 1651769207);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1651769207);
user_pref("services.settings.main.hijack-blocklists.last_check", 1651769207);
user_pref("services.settings.main.language-dictionaries.last_check", 1651769207);
user_pref("services.settings.main.message-groups.last_check", 1651769207);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1651769207);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1651769207);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1651769207);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1651769207);
user_pref("services.settings.main.password-recipes.last_check", 1651769207);
user_pref("services.settings.main.password-rules.last_check", 1651769207);
user_pref("services.settings.main.personality-provider-models.last_check", 1651769207);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1651769207);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1651769207);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1651769207);
user_pref("services.settings.main.public-suffix-list.last_check", 1651769207);
user_pref("services.settings.main.query-stripping.last_check", 1651769207);
user_pref("services.settings.main.search-config.last_check", 1651769207);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1651769207);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1651769207);
user_pref("services.settings.main.search-telemetry.last_check", 1651769207);
user_pref("services.settings.main.sites-classification.last_check", 1651769207);
user_pref("services.settings.main.tippytop.last_check", 1651769207);
user_pref("services.settings.main.top-sites.last_check", 1651769207);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1651769207);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1651769207);
user_pref("services.settings.main.whats-new-panel.last_check", 1651769207);
user_pref("services.settings.security.onecrl.checked", 1651555585);
user_pref("services.sync.addons.lastSync", "1651575024.27");
...
user_pref("services.sync.clients.lastRecordUpload", 1651769209);
user_pref("services.sync.clients.lastSync", "1651769209.7");
...
user_pref("services.sync.lastPing", 1651687912);
user_pref("services.sync.lastSync", "Thu May 05 2022 18:48:21 GMT+0200 (Central European Summer Time)");
user_pref("services.sync.lastTabFetch", 1586120826);
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.passwords.syncID", "-WeMPm6W3NJC");
user_pref("services.sync.prefs.lastSync", "1649938251.22");
...
user_pref("storage.vacuum.last.places.sqlite", 1649583945);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.scrollbox.horizontalScrollDistance", 4);
user_pref("toolkit.startup.last_success", 1651769199);
