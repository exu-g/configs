...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1648485436);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1648534732);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1648531492);
user_pref("app.update.lastUpdateTime.region-update-timer", 1648302630);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1648531252);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1648531372);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1648485316);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1648302750);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1648485556);
...
user_pref("browser.region.update.updated", 1648302630);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1648536489244");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1648538269244");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1648531105883");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1648552705883");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1648531103");
...
user_pref("browser.startup.lastColdStartupCheck", 1648531103);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1648485437);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1648485785);
...
user_pref("idle.lastDailyNotification", 1648485603);
...
user_pref("media.gmp-manager.lastCheck", 1648485564);
...
user_pref("places.database.lastMaintenance", 1648485604);
...
user_pref("security.remote_settings.crlite_filters.checked", 1648535049);
user_pref("security.remote_settings.intermediates.checked", 1648535049);
...
user_pref("services.blocklist.addons-mlbf.checked", 1648535049);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1648535049);
user_pref("services.blocklist.pinning.checked", 1591805812);
user_pref("services.blocklist.plugins.checked", 1591867368);
user_pref("services.settings.clock_skew_seconds", -932);
user_pref("services.settings.last_etag", "\"1648522634563\"");
user_pref("services.settings.last_update_seconds", 1648536030);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1648535049);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1648535049);
user_pref("services.settings.main.doh-config.last_check", 1648535049);
user_pref("services.settings.main.doh-providers.last_check", 1648535049);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1648535049);
user_pref("services.settings.main.hijack-blocklists.last_check", 1648535049);
user_pref("services.settings.main.language-dictionaries.last_check", 1648535049);
user_pref("services.settings.main.message-groups.last_check", 1648535049);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1648535049);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1648535049);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1648535049);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1648535049);
user_pref("services.settings.main.password-recipes.last_check", 1648535049);
user_pref("services.settings.main.password-rules.last_check", 1648535049);
user_pref("services.settings.main.personality-provider-models.last_check", 1648535049);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1648535049);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1648535049);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1648535049);
user_pref("services.settings.main.public-suffix-list.last_check", 1648535049);
user_pref("services.settings.main.query-stripping.last_check", 1648535049);
user_pref("services.settings.main.search-config.last_check", 1648535049);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1648535049);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1648535049);
user_pref("services.settings.main.search-telemetry.last_check", 1648535049);
user_pref("services.settings.main.sites-classification.last_check", 1648535049);
user_pref("services.settings.main.tippytop.last_check", 1648535049);
user_pref("services.settings.main.top-sites.last_check", 1648535049);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1648535049);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1648535049);
user_pref("services.settings.main.whats-new-panel.last_check", 1648535049);
user_pref("services.settings.security.onecrl.checked", 1648535049);
user_pref("services.sync.addons.lastSync", "1647777346.81");
...
user_pref("services.sync.clients.lastRecordUpload", 1648531120);
user_pref("services.sync.clients.lastSync", "1648531120.05");
...
user_pref("services.sync.lastPing", 1648485183);
user_pref("services.sync.lastSync", "Tue Mar 29 2022 09:01:09 GMT+0200 (Central European Summer Time)");
...
user_pref("toolkit.startup.last_success", 1648531101);
