...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1650787244);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1650824845);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1650825085);
user_pref("app.update.lastUpdateTime.region-update-timer", 1650803338);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1650825256);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1650824965);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1650787124);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1650803458);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1650787364);
...
user_pref("browser.region.update.updated", 1650803339);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1650824700474");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1650826521474");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1650824701194");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1650846301194");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1650825257");
...
user_pref("browser.startup.lastColdStartupCheck", 1650825257);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1650787245);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1650787472);
...
user_pref("idle.lastDailyNotification", 1650791848);
...
user_pref("media.gmp-manager.lastCheck", 1650824728);
...
user_pref("places.database.lastMaintenance", 1650226167);
...
user_pref("security.remote_settings.crlite_filters.checked", 1650791059);
user_pref("security.remote_settings.intermediates.checked", 1650791059);
...
user_pref("services.blocklist.addons-mlbf.checked", 1650824700);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1650824700);
...
user_pref("services.settings.last_etag", "\"1650812270014\"");
user_pref("services.settings.last_update_seconds", 1650824700);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1650824700);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1650824700);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1650824700);
user_pref("services.settings.main.doh-config.last_check", 1650824700);
user_pref("services.settings.main.doh-providers.last_check", 1650824700);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1650824700);
user_pref("services.settings.main.hijack-blocklists.last_check", 1650824700);
user_pref("services.settings.main.language-dictionaries.last_check", 1650824700);
user_pref("services.settings.main.message-groups.last_check", 1650824700);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1650824700);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1650824700);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1650824700);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1650824700);
user_pref("services.settings.main.password-recipes.last_check", 1650824700);
user_pref("services.settings.main.password-rules.last_check", 1650824700);
user_pref("services.settings.main.personality-provider-models.last_check", 1650824700);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1650824700);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1650824700);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1650824700);
user_pref("services.settings.main.public-suffix-list.last_check", 1650824700);
user_pref("services.settings.main.query-stripping.last_check", 1650824700);
user_pref("services.settings.main.search-config.last_check", 1650824700);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1650824700);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1650824700);
user_pref("services.settings.main.search-telemetry.last_check", 1650824700);
user_pref("services.settings.main.sites-classification.last_check", 1650824700);
user_pref("services.settings.main.tippytop.last_check", 1650824700);
user_pref("services.settings.main.top-sites.last_check", 1650824700);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1650824700);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1650824700);
user_pref("services.settings.main.whats-new-panel.last_check", 1650824700);
user_pref("services.settings.security.onecrl.checked", 1650787124);
user_pref("services.sync.addons.lastSync", "1649878048.55");
...
user_pref("services.sync.clients.lastRecordUpload", 1650825276);
user_pref("services.sync.clients.lastSync", "1650825276.44");
...
user_pref("services.sync.lastPing", 1650786870);
user_pref("services.sync.lastSync", "Sun Apr 24 2022 20:34:36 GMT+0200 (Central European Summer Time)");
...
user_pref("toolkit.startup.last_success", 1650825251);
