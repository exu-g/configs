...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1654774557);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1654774917);
user_pref("app.update.lastUpdateTime.region-update-timer", 1654710607);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1654774677);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1654774797);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1654774532980");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1654796132980");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1654752928");
...
user_pref("browser.startup.lastColdStartupCheck", 1654752928);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1654752929);
...
user_pref("services.settings.last_etag", "\"1654757835402\"");
user_pref("services.settings.last_update_seconds", 1654758333);
user_pref("services.settings.main.addons-manager-settings.last_check", 1654758333);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1654758333);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1654758333);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1654758333);
user_pref("services.settings.main.doh-config.last_check", 1654758333);
user_pref("services.settings.main.doh-providers.last_check", 1654758333);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1654758333);
user_pref("services.settings.main.hijack-blocklists.last_check", 1654758333);
user_pref("services.settings.main.language-dictionaries.last_check", 1654758333);
user_pref("services.settings.main.message-groups.last_check", 1654758333);
...
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1654758333);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1654758333);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1654758333);
user_pref("services.settings.main.password-recipes.last_check", 1654758333);
user_pref("services.settings.main.password-rules.last_check", 1654758333);
user_pref("services.settings.main.personality-provider-models.last_check", 1654758333);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1654758333);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1654758333);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1654715144);
user_pref("services.settings.main.public-suffix-list.last_check", 1654758333);
user_pref("services.settings.main.query-stripping.last_check", 1654758333);
user_pref("services.settings.main.search-config.last_check", 1654758333);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1654758333);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1654758333);
user_pref("services.settings.main.search-telemetry.last_check", 1654715144);
user_pref("services.settings.main.sites-classification.last_check", 1654758333);
user_pref("services.settings.main.tippytop.last_check", 1654758333);
user_pref("services.settings.main.top-sites.last_check", 1654758333);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1654758333);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1654758333);
user_pref("services.settings.main.whats-new-panel.last_check", 1654758333);
...
user_pref("services.sync.clients.lastRecordUpload", 1654752932);
user_pref("services.sync.clients.lastSync", "1654774914.03");
...
user_pref("services.sync.lastSync", "Thu Jun 09 2022 13:42:51 GMT+0200 (Mitteleuropäische Sommerzeit)");
...
user_pref("toolkit.startup.last_success", 1654752926);
user_pref("toolkit.telemetry.cachedClientID", "57623376-42e1-434b-a7d1-debde00c97a1");
