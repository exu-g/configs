...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1642447495);
...
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1642499264);
user_pref("app.update.lastUpdateTime.region-update-timer", 1642507543);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1642604892);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1642499144);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1642447375);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1642507663);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1642447615);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1642447496);
...
user_pref("idle.lastDailyNotification", 1642446497);
...
user_pref("places.database.lastMaintenance", 1641902624);
...
user_pref("security.remote_settings.crlite_filters.checked", 1642518229);
user_pref("security.remote_settings.intermediates.checked", 1642518229);
...
user_pref("services.blocklist.addons-mlbf.checked", 1642604902);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1642604902);
...
user_pref("services.settings.last_etag", "\"1642604267313\"");
user_pref("services.settings.last_update_seconds", 1642604902);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1642604902);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1642604902);
user_pref("services.settings.main.doh-config.last_check", 1642604902);
user_pref("services.settings.main.doh-providers.last_check", 1642604902);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1642604902);
user_pref("services.settings.main.hijack-blocklists.last_check", 1642604902);
user_pref("services.settings.main.language-dictionaries.last_check", 1642604902);
user_pref("services.settings.main.message-groups.last_check", 1642604902);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1642604902);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1642604902);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1642604902);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1642604902);
user_pref("services.settings.main.password-recipes.last_check", 1642604902);
user_pref("services.settings.main.password-rules.last_check", 1642604902);
user_pref("services.settings.main.personality-provider-models.last_check", 1642604902);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1642604902);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1642604902);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1642604902);
user_pref("services.settings.main.public-suffix-list.last_check", 1642604902);
user_pref("services.settings.main.query-stripping.last_check", 1642604902);
user_pref("services.settings.main.search-config.last_check", 1642604902);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1642604902);
user_pref("services.settings.main.search-telemetry.last_check", 1642604902);
user_pref("services.settings.main.sites-classification.last_check", 1642604902);
user_pref("services.settings.main.tippytop.last_check", 1642604902);
user_pref("services.settings.main.top-sites.last_check", 1642604902);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1642604902);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1642604902);
user_pref("services.settings.main.whats-new-panel.last_check", 1642604902);
user_pref("services.settings.security.onecrl.checked", 1642505624);
...
user_pref("services.sync.lastSync", "Wed Jan 19 2022 16:08:29 GMT+0100 (Central European Standard Time)");
user_pref("services.sync.lastTabFetch", 1586120826);
user_pref("services.sync.nextSync", 1642605509);
