...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1704910507);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1704914107);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1704910507);
user_pref("app.update.lastUpdateTime.region-update-timer", 1704461757);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1704910507);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1704910507);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1704465357);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1704910507);
...
user_pref("browser.region.update.updated", 1704461758);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.malware.enabled", false);
user_pref("browser.safebrowsing.phishing.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1704910480199");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1704932080199");
...
user_pref("browser.startup.lastColdStartupCheck", 1704910478);
...
user_pref("extensions.dnr.lastStoreUpdateTag.5f25abbb-d076-4c4f-b285-9a0086d69305", "{a4f6b7d4-4808-472d-9b09-df8eb88da81d}");
user_pref("extensions.getAddons.cache.lastUpdate", 1704910509);
...
user_pref("identity.fxaccounts.account.device.name", "marcâ€™s Firefox on lupusregina");
user_pref("identity.fxaccounts.account.telemetry.sanitized_uid", "7d43bb2e98e00c17c235782ba1e87861");
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1704911084);
...
user_pref("media.gmp-gmpopenh264.lastDownload", 1702915653);
...
user_pref("media.gmp-gmpopenh264.lastInstallStart", 1702915652);
user_pref("media.gmp-gmpopenh264.lastUpdate", 1702915653);
user_pref("media.gmp-gmpopenh264.version", "2.3.2");
user_pref("media.gmp-manager.buildID", "20240109145044");
user_pref("media.gmp-manager.lastCheck", 1704910499);
user_pref("media.gmp-manager.lastEmptyCheck", 1704910499);
...
user_pref("places.database.lastMaintenance", 1704746135);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1704912283);
user_pref("services.settings.blocklists.gfx.last_check", 1704912283);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1704913010476\"");
user_pref("services.settings.last_update_seconds", 1704914087);
user_pref("services.settings.main.addons-manager-settings.last_check", 1704912283);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1704912283);
user_pref("services.settings.main.cfr.last_check", 1704912283);
user_pref("services.settings.main.cookie-banner-rules-list.last_check", 1704912283);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1704912283);
user_pref("services.settings.main.devtools-devices.last_check", 1704912283);
user_pref("services.settings.main.doh-config.last_check", 1704912283);
user_pref("services.settings.main.doh-providers.last_check", 1704912283);
user_pref("services.settings.main.fingerprinting-protection-overrides.last_check", 1704912283);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1704912283);
user_pref("services.settings.main.hijack-blocklists.last_check", 1704912283);
user_pref("services.settings.main.language-dictionaries.last_check", 1704912283);
user_pref("services.settings.main.message-groups.last_check", 1704912283);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1704912283);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1704912283);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1704912283);
user_pref("services.settings.main.password-recipes.last_check", 1704912283);
user_pref("services.settings.main.password-rules.last_check", 1704912283);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1704912283);
user_pref("services.settings.main.public-suffix-list.last_check", 1704912283);
user_pref("services.settings.main.query-stripping.last_check", 1704912283);
user_pref("services.settings.main.search-config-v2.last_check", 1704912283);
user_pref("services.settings.main.search-config.last_check", 1704912283);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1704912283);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1704912283);
user_pref("services.settings.main.sites-classification.last_check", 1704912283);
user_pref("services.settings.main.tippytop.last_check", 1704912283);
user_pref("services.settings.main.top-sites.last_check", 1704912283);
user_pref("services.settings.main.translations-identification-models.last_check", 1704912283);
user_pref("services.settings.main.translations-models.last_check", 1704912283);
user_pref("services.settings.main.translations-wasm.last_check", 1704912283);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1704912283);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1704912283);
user_pref("services.settings.main.whats-new-panel.last_check", 1704912283);
user_pref("services.settings.security-state.cert-revocations.last_check", 1704912283);
user_pref("services.settings.security-state.intermediates.last_check", 1704912283);
user_pref("services.settings.security-state.onecrl.last_check", 1704912283);
...
user_pref("services.sync.clients.lastRecordUpload", 1704910483);
user_pref("services.sync.clients.lastSync", "1704910483.56");
...
user_pref("services.sync.lastPing", 1704910482);
user_pref("services.sync.lastSync", "Wed Jan 10 2024 20:41:46 GMT+0100 (Mitteleuropäische Normalzeit)");
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.prefs.lastSync", "1702213177.07");
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1704746135);
user_pref("storage.vacuum.last.index", 1);
user_pref("storage.vacuum.last.places.sqlite", 1704659626);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.startup.last_success", 1704910476);
