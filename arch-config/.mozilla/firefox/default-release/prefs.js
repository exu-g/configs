...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1661708453);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1661793453);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1661697370);
user_pref("app.update.lastUpdateTime.region-update-timer", 1661265425);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1661793431);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1661697130);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1661708333);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1661265545);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1661708573);
...
user_pref("browser.region.update.updated", 1661265426);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1661793434689");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1661815034689");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1661793431");
...
user_pref("browser.startup.lastColdStartupCheck", 1661793431);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1661708453);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1661711419);
...
user_pref("idle.lastDailyNotification", 1661632588);
...
user_pref("media.gmp-manager.lastCheck", 1661675412);
user_pref("media.gmp-manager.lastEmptyCheck", 1661675412);
...
user_pref("places.database.lastMaintenance", 1661362292);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1661793434);
user_pref("services.settings.blocklists.gfx.last_check", 1661793434);
user_pref("services.settings.clock_skew_seconds", 1);
user_pref("services.settings.last_etag", "\"1661777876844\"");
user_pref("services.settings.last_update_seconds", 1661793434);
user_pref("services.settings.main.addons-manager-settings.last_check", 1661793434);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1661793434);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1661793434);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1661793434);
user_pref("services.settings.main.devtools-devices.last_check", 1661793434);
user_pref("services.settings.main.doh-config.last_check", 1661793434);
user_pref("services.settings.main.doh-providers.last_check", 1661793434);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1661793434);
user_pref("services.settings.main.hijack-blocklists.last_check", 1661793434);
user_pref("services.settings.main.language-dictionaries.last_check", 1661793434);
user_pref("services.settings.main.message-groups.last_check", 1661793434);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1661793434);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1661793434);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1661793434);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1661793434);
user_pref("services.settings.main.password-recipes.last_check", 1661793434);
user_pref("services.settings.main.password-rules.last_check", 1661793434);
user_pref("services.settings.main.personality-provider-models.last_check", 1661793434);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1661793434);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1661793434);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1661793434);
user_pref("services.settings.main.public-suffix-list.last_check", 1661793434);
user_pref("services.settings.main.query-stripping.last_check", 1661793434);
user_pref("services.settings.main.search-config.last_check", 1661793434);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1661793434);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1661793434);
user_pref("services.settings.main.search-telemetry.last_check", 1661793434);
user_pref("services.settings.main.sites-classification.last_check", 1661793434);
user_pref("services.settings.main.tippytop.last_check", 1661793434);
user_pref("services.settings.main.top-sites.last_check", 1661793434);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1661793434);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1661793434);
user_pref("services.settings.main.whats-new-panel.last_check", 1661793434);
user_pref("services.settings.security-state.cert-revocations.last_check", 1661713514);
user_pref("services.settings.security-state.intermediates.last_check", 1661691901);
user_pref("services.settings.security-state.onecrl.last_check", 1661691901);
...
user_pref("services.sync.clients.lastRecordUpload", 1661793437);
user_pref("services.sync.clients.lastSync", "1661793437.68");
...
user_pref("services.sync.lastPing", 1661709014);
user_pref("services.sync.lastSync", "Mon Aug 29 2022 19:17:18 GMT+0200 (Central European Summer Time)");
...
user_pref("toolkit.startup.last_success", 1661793420);
