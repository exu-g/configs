...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1717438629);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1717480397);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1717476793);
user_pref("app.update.lastUpdateTime.region-update-timer", 1717175945);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1717476793);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1717438629);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1717179542);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1717438629);
...
user_pref("browser.region.update.updated", 1717175946);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.malware.enabled", false);
user_pref("browser.safebrowsing.phishing.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1717476763180");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1717498363180");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20230925122949");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1717476762");
...
user_pref("browser.startup.lastColdStartupCheck", 1717476762);
...
user_pref("extensions.dnr.lastStoreUpdateTag.5f25abbb-d076-4c4f-b285-9a0086d69305", "{e2bb2ba5-177d-4e83-a4bd-d36a45e9c92c}");
user_pref("extensions.getAddons.cache.lastUpdate", 1717476763);
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1717439394);
...
user_pref("idle.lastDailyNotification", 1717440752);
...
user_pref("media.gmp-gmpopenh264.lastDownload", 1715966279);
...
user_pref("media.gmp-gmpopenh264.lastDownloadFailed", 1714378993);
user_pref("media.gmp-gmpopenh264.lastInstallStart", 1715966278);
user_pref("media.gmp-gmpopenh264.lastUpdate", 1715966279);
user_pref("media.gmp-gmpopenh264.version", "2.3.2");
user_pref("media.gmp-manager.buildID", "20240527213814");
user_pref("media.gmp-manager.lastCheck", 1717443744);
user_pref("media.gmp-manager.lastEmptyCheck", 1717443744);
...
user_pref("nimbus.syncdefaultsstore.phc", "{\"slug\":\"phc-rollout\",\"branch\":{\"slug\":\"rollout\",\"ratio\":1,\"feature\":{\"value\":null,\"enabled\":true,\"featureId\":\"phc\"},\"features\":null},\"active\":true,\"experimentType\":\"rollout\",\"source\":\"rs-loader\",\"userFacingName\":\"PHC Rollout\",\"userFacingDescription\":\"Roll out the Probabilistic Heap Checker in Firefox Release.\",\"lastSeen\":\"2024-03-15T19:19:54.320Z\",\"featureIds\":[\"phc\"],\"prefs\":[{\"name\":\"memory.phc.enabled\",\"branch\":\"user\",\"featureId\":\"phc\",\"variable\":\"phcEnabled\",\"originalValue\":null}],\"isRollout\":true}");
...
user_pref("places.database.lastMaintenance", 1717266314);
...
user_pref("services.settings.blocklists.addons-bloomfilters.last_check", 1717477300);
user_pref("services.settings.blocklists.gfx.last_check", 1717477300);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1717477032144\"");
user_pref("services.settings.last_update_seconds", 1717480905);
user_pref("services.settings.main.addons-manager-settings.last_check", 1717477300);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1717477300);
user_pref("services.settings.main.cfr.last_check", 1717477300);
user_pref("services.settings.main.cookie-banner-rules-list.last_check", 1717477300);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1717477300);
user_pref("services.settings.main.devtools-devices.last_check", 1717477300);
user_pref("services.settings.main.doh-config.last_check", 1717477300);
user_pref("services.settings.main.doh-providers.last_check", 1717477300);
user_pref("services.settings.main.fingerprinting-protection-overrides.last_check", 1717477300);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1717477300);
user_pref("services.settings.main.hijack-blocklists.last_check", 1717477300);
user_pref("services.settings.main.language-dictionaries.last_check", 1717477300);
user_pref("services.settings.main.message-groups.last_check", 1717477300);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1717477300);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1717477300);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1717477300);
user_pref("services.settings.main.password-recipes.last_check", 1717477300);
user_pref("services.settings.main.password-rules.last_check", 1717477300);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1717477300);
user_pref("services.settings.main.public-suffix-list.last_check", 1717477300);
user_pref("services.settings.main.query-stripping.last_check", 1717477300);
user_pref("services.settings.main.search-config-icons.last_check", 1717477300);
user_pref("services.settings.main.search-config-overrides-v2.last_check", 1717477300);
user_pref("services.settings.main.search-config-overrides.last_check", 1717477300);
user_pref("services.settings.main.search-config-v2.last_check", 1717477300);
user_pref("services.settings.main.search-config.last_check", 1717477300);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1717477300);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1717477300);
user_pref("services.settings.main.sites-classification.last_check", 1717477300);
user_pref("services.settings.main.tippytop.last_check", 1717477300);
user_pref("services.settings.main.top-sites.last_check", 1717477300);
user_pref("services.settings.main.translations-identification-models.last_check", 1717477300);
user_pref("services.settings.main.translations-models.last_check", 1717477300);
user_pref("services.settings.main.translations-wasm.last_check", 1717477300);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1717477300);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1717477300);
user_pref("services.settings.main.whats-new-panel.last_check", 1717477300);
user_pref("services.settings.security-state.cert-revocations.last_check", 1717477300);
user_pref("services.settings.security-state.intermediates.last_check", 1717477300);
user_pref("services.settings.security-state.onecrl.last_check", 1717477300);
user_pref("services.sync.addons.lastSync", "1716403410.22");
...
user_pref("services.sync.clients.lastRecordUpload", 1717476767);
user_pref("services.sync.clients.lastSync", "1717476767.77");
...
user_pref("services.sync.lastPing", 1717438791);
user_pref("services.sync.lastSync", "Tue Jun 04 2024 08:41:45 GMT+0200 (Mitteleuropäische Sommerzeit)");
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1716401173);
user_pref("storage.vacuum.last.index", 2);
user_pref("storage.vacuum.last.places.sqlite", 1716313391);
user_pref("svg.context-properties.content.enabled", true);
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);
user_pref("toolkit.startup.last_success", 1717476760);
