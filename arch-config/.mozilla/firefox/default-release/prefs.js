...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1653151812);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1588944333);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1653228525);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1653212621);
user_pref("app.update.lastUpdateTime.region-update-timer", 1652723035);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1653224898);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1653212501);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1653151692);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1652723155);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1653151932);
...
user_pref("browser.region.update.updated", 1652723036);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1653228551017");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1653230377017");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1653212358778");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1653233958778");
user_pref("browser.search.region", "CH");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20211121002925");
user_pref("browser.shell.checkDefaultBrowser", true);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1653224898");
...
user_pref("browser.startup.lastColdStartupCheck", 1653224898);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1653151813);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{873f9a27-c9cd-499c-8a3e-c94d88b520f2}\",\"addons\":{\"webcompat@mozilla.org\":{\"version\":\"100.2.1buildid20220504.194401\"}}}");
...
user_pref("identity.fxaccounts.commands.missed.last_fetch", 1653153284);
...
user_pref("idle.lastDailyNotification", 1653155380);
...
user_pref("media.gmp-manager.lastCheck", 1653212381);
...
user_pref("places.database.lastMaintenance", 1653067872);
...
user_pref("security.remote_settings.crlite_filters.checked", 1653145522);
user_pref("security.remote_settings.intermediates.checked", 1653145522);
...
user_pref("services.blocklist.addons-mlbf.checked", 1653212356);
user_pref("services.blocklist.addons.checked", 1591867368);
user_pref("services.blocklist.gfx.checked", 1653212356);
...
user_pref("services.settings.last_etag", "\"1653209829142\"");
user_pref("services.settings.last_update_seconds", 1653212356);
user_pref("services.settings.main.addons-manager-settings.last_check", 1653212356);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1653212356);
user_pref("services.settings.main.cfr-fxa.last_check", 1629621510);
user_pref("services.settings.main.cfr.last_check", 1653212356);
user_pref("services.settings.main.devtools-compatibility-browsers.last_check", 1653212356);
user_pref("services.settings.main.doh-config.last_check", 1653212356);
user_pref("services.settings.main.doh-providers.last_check", 1653212356);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1653212356);
user_pref("services.settings.main.hijack-blocklists.last_check", 1653212356);
user_pref("services.settings.main.language-dictionaries.last_check", 1653212356);
user_pref("services.settings.main.message-groups.last_check", 1653212356);
user_pref("services.settings.main.messaging-experiments.last_check", 1591867368);
user_pref("services.settings.main.nimbus-desktop-defaults.last_check", 1653212356);
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1653212356);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1653212356);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1653212356);
user_pref("services.settings.main.password-recipes.last_check", 1653212356);
user_pref("services.settings.main.password-rules.last_check", 1653212356);
user_pref("services.settings.main.personality-provider-models.last_check", 1653212356);
user_pref("services.settings.main.personality-provider-recipe.last_check", 1653212356);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1653212356);
user_pref("services.settings.main.pioneer-study-addons.last_check", 1653212356);
user_pref("services.settings.main.public-suffix-list.last_check", 1653212356);
user_pref("services.settings.main.query-stripping.last_check", 1653212356);
user_pref("services.settings.main.search-config.last_check", 1653212356);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1653212356);
user_pref("services.settings.main.search-telemetry-v2.last_check", 1653212356);
user_pref("services.settings.main.search-telemetry.last_check", 1653212356);
user_pref("services.settings.main.sites-classification.last_check", 1653212356);
user_pref("services.settings.main.tippytop.last_check", 1653212356);
user_pref("services.settings.main.top-sites.last_check", 1653212356);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1653212356);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1653212356);
user_pref("services.settings.main.whats-new-panel.last_check", 1653212356);
user_pref("services.settings.security.onecrl.checked", 1653145522);
...
user_pref("services.sync.clients.lastRecordUpload", 1653224901);
user_pref("services.sync.clients.lastSync", "1653224901.8");
...
user_pref("services.sync.lastPing", 1653152682);
user_pref("services.sync.lastSync", "Sun May 22 2022 16:04:30 GMT+0200 (Central European Summer Time)");
...
user_pref("toolkit.startup.last_success", 1653224892);
