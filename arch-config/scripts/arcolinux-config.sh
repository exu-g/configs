...
#gimp plugins
mkdir ~/.config/GIMP/ > /dev/null || echo Not creating directory
mkdir ~/.config/GIMP/2.10/ > /dev/null || echo Not creating directory
mkdir ~/.config/GIMP/2.10/plug-ins/ > /dev/null || echo Not creating directory
